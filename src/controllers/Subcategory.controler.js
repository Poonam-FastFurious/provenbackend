...
export const createSubCategory = async (req, res) => {
      try {
            ...
            if (![subCategoryTitle, link, categoryName].every((field) => field?.trim())) {
                  throw new ApiError(400, "Subcategory title, link, and category name are required");
            }
            ...
            return res.status(201).json(
                  new ApiResponse(200, { ...subCategory.toObject(), category: categoryNameResponse }, "Subcategory created successfully")
            );
      } catch (error) {
